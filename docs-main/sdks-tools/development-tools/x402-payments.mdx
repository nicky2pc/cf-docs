...
```json
{
  ...
  "extra": {
    "transferMethod": "external-party-amulet-rules",
    "facilitatorParty": "<facilitator-party>::1220...",
    "synchronizerId": "global-domain::1220..."
  }
}
```

`amount` is a Daml Decimal string — always 10 decimal places. `"1.0000000000"` = 1 CC. The facilitator does a strict string comparison against the on-ledger value; numeric coercion is not applied.
