...
```bash
canton-agent-wallet create --relay-url https://<your-facilitator>
...
```bash
canton-agent-wallet balance --relay-url https://<your-facilitator>
...
```bash
canton-agent-wallet claim --relay-url https://<your-facilitator>
...
```bash
canton-agent-wallet pay --relay-url https://<your-facilitator> https://api.example.com/resource
```
...
```bash
# Partial amount
canton-agent-wallet withdraw --relay-url https://<your-facilitator> --to "recipient::1220..." --amount 5.0000000000

# Full balance
canton-agent-wallet withdraw --relay-url https://<your-facilitator> --to "recipient::1220..."
```
